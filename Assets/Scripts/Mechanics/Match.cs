...
//    public Match(Cell origin, Cell[] horizontal, Cell[] vertical, Cell[] square)
//    {
//        Type = MatchType.Standart;

//        TypeId = (int)origin.Type;
//        if (horizontal.Length >= 2 && vertical.Length >= 2)
//        {
//            Type = MatchType.FiveFigure;
